...
Once the `conda-forge` channel has been enabled, `mkdocs-jupyter` can be installed with:

```
conda install mkdocs-jupyter
```

It is possible to list all of the versions of `mkdocs-jupyter` available on your platform with:
